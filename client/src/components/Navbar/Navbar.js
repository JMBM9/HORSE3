...
import blackpegasus from '../../images/blackpegasus.png';
  ...
  return (
    <AppBar className={classes.appBar} position="static" color="inherit">
      <div className={classes.brandContainer}>
        <Typography component={Link} to="/" className={classes.heading} variant="h2" align="center">HORSE</Typography>
        <img className={classes.image} src={blackpegasus} alt="icon" height="80" />
      </div>
